...
class Settings:
    ...
    TRADING_MIN_AGE_HOURS: float = float(os.getenv("TRADING_MIN_AGE_HOURS", "1.0"))
    TRADING_MAX_AGE_HOURS: float = float(os.getenv("TRADING_MAX_AGE_HOURS", "48"))
    TRADING_MAX_ABSOLUTE_PERCENT_5M: float = float(os.getenv("TRADING_MAX_ABSOLUTE_PERCENT_5M", "15"))
