...
class Settings:
    ...
    TRADING_GATE_SHADOWING_REGIME_ENABLED: bool = _as_bool(os.getenv("TRADING_GATE_SHADOWING_REGIME_ENABLED"), True)
    ...
    TRADING_CORTEX_FEATURE_SET_VERSION: str = os.getenv("TRADING_CORTEX_FEATURE_SET_VERSION", "poseidon_shadow_v2")
    ...
    TRADING_CORTEX_TRAINING_MINIMUM_LABELED_RECORD_COUNT: int = int(os.getenv("TRADING_CORTEX_TRAINING_MINIMUM_LABELED_RECORD_COUNT", "10000"))
    ...
    TRADING_SHADOWING_REGIME_CHRONICLE_PROFIT_FACTOR_MOVING_AVERAGE_LOOKBACK_DAYS: float = float(os.getenv("TRADING_SHADOWING_REGIME_CHRONICLE_PROFIT_FACTOR_MOVING_AVERAGE_LOOKBACK_DAYS", "7.0"))
    TRADING_SHADOWING_REGIME_CHRONICLE_PROFIT_FACTOR_BUCKET_WIDTH_SECONDS: int = int(os.getenv("TRADING_SHADOWING_REGIME_CHRONICLE_PROFIT_FACTOR_BUCKET_WIDTH_SECONDS", "300"))
    TRADING_SHADOWING_REGIME_CHRONICLE_PROFIT_FACTOR_MOVING_AVERAGE_PERIOD: int = int(os.getenv("TRADING_SHADOWING_REGIME_CHRONICLE_PROFIT_FACTOR_MOVING_AVERAGE_PERIOD", "10"))
    TRADING_SHADOWING_REGIME_CHRONICLE_PROFIT_FACTOR_THRESHOLD: float = float(os.getenv("TRADING_SHADOWING_REGIME_CHRONICLE_PROFIT_FACTOR_THRESHOLD", "1.40"))
    TRADING_SHADOWING_REGIME_SPARSE_EXPECTED_VALUE_MOVING_AVERAGE_LOOKBACK_DAYS: float = float(os.getenv("TRADING_SHADOWING_REGIME_SPARSE_EXPECTED_VALUE_MOVING_AVERAGE_LOOKBACK_DAYS", "7.0"))
    TRADING_SHADOWING_REGIME_SPARSE_EXPECTED_VALUE_BUCKET_WIDTH_SECONDS: int = int(os.getenv("TRADING_SHADOWING_REGIME_SPARSE_EXPECTED_VALUE_BUCKET_WIDTH_SECONDS", "600"))
    TRADING_SHADOWING_REGIME_SPARSE_EXPECTED_VALUE_MOVING_AVERAGE_PERIOD: int = int(os.getenv("TRADING_SHADOWING_REGIME_SPARSE_EXPECTED_VALUE_MOVING_AVERAGE_PERIOD", "10"))
    TRADING_SHADOWING_REGIME_SPARSE_EXPECTED_VALUE_USD_THRESHOLD: float = float(os.getenv("TRADING_SHADOWING_REGIME_SPARSE_EXPECTED_VALUE_USD_THRESHOLD", "0.0"))
