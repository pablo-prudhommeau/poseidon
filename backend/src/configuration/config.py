...
class Settings:
    ...
    TRADING_GATE_CORTEX_ENABLED: bool = _as_bool(os.getenv("TRADING_GATE_CORTEX_ENABLED"), False)
    TRADING_GATE_SHADOWING_ENABLED: bool = _as_bool(os.getenv("TRADING_GATE_SHADOWING_ENABLED"), False)
