...
class Settings:
    ...
    SCORE_MIN_RANK: float = float(os.getenv("SCORE_MIN_RANK", "55"))
    ...
    # Global switch
    TRADING_LIVE_ENABLED: bool = _as_bool(os.getenv("TRADING_LIVE_ENABLED"), False)

    # EVM signer (HD via eth-account)
    ...
    # Solana signer (base58 secret key; no mnemonic ingestion inside the code)
    SOLANA_RPC_URL: str = os.getenv("SOLANA_RPC_URL", "https://api.mainnet-beta.solana.com")
    SOLANA_SECRET_KEY_BASE58: str = os.getenv("SOLANA_SECRET_KEY_BASE58", "")

    # LI.FI public API (used for quotes and routes)
    LIFI_BASE_URL: str = os.getenv("LIFI_BASE_URL", "https://li.quest")

    # JUPITER
    JUPITER_BASE_URL: str = os.getenv("JUPITER_BASE_URL", "https://lite-api.jup.ag").rstrip("/")
