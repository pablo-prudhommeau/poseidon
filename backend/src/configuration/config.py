...
class Settings:
    ...
    TRADING_CORTEX_SUCCESS_PROBABILITY_THRESHOLD: float = float(os.getenv("TRADING_CORTEX_SUCCESS_PROBABILITY_THRESHOLD", "0.5"))
    TRADING_CORTEX_TOXICITY_PROBABILITY_THRESHOLD: float = float(os.getenv("TRADING_CORTEX_TOXICITY_PROBABILITY_THRESHOLD", "0.5"))
    TRADING_CORTEX_PNL_THRESHOLD: float = float(os.getenv("TRADING_CORTEX_PNL_THRESHOLD", "0.0"))
    TRADING_CORTEX_HOLDING_TIME_MAX_HOURS: float = float(os.getenv("TRADING_CORTEX_HOLDING_TIME_MAX_HOURS", "16.0"))
