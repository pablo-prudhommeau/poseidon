...
class Settings:
    ...
    TRADING_SOLANA_GAS_REFILL_THRESHOLD_MULTIPLIER: float = float(os.getenv("TRADING_SOLANA_GAS_REFILL_THRESHOLD_MULTIPLIER", "4.0"))
    TRADING_SOLANA_GAS_REFILL_TARGET_MULTIPLIER: float = float(os.getenv("TRADING_SOLANA_GAS_REFILL_TARGET_MULTIPLIER", "16.0"))
