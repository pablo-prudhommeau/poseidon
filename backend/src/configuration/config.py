...
class Settings:
    ...
    TRADING_SHADOWING_TOXIC_AVERAGE_PNL_THRESHOLD: float = float(os.getenv("TRADING_SHADOWING_TOXIC_AVERAGE_PNL_THRESHOLD", "-0.03"))
    TRADING_SHADOWING_TOXIC_HOLDING_TIME_THRESHOLD: float = float(os.getenv("TRADING_SHADOWING_TOXIC_HOLDING_TIME_THRESHOLD", "12.0"))
