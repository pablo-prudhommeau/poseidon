...
class Settings:
    ...
    TRADING_CORTEX_FEATURE_SET_VERSION: str = os.getenv("TRADING_CORTEX_FEATURE_SET_VERSION", "poseidon_shadow_v1")
    ...
    TRADING_CORTEX_DEFAULT_FEATURE_SET_VERSION: str = os.getenv("TRADING_CORTEX_DEFAULT_FEATURE_SET_VERSION", "poseidon_shadow_v1")
    TRADING_CORTEX_EXPECTED_PROFIT_AND_LOSS_TEMPERATURE: float = float(os.getenv("TRADING_CORTEX_EXPECTED_PROFIT_AND_LOSS_TEMPERATURE", "100.0"))
    ...
    TRADING_SHADOWING_REGIME_CHRONICLE_PROFIT_FACTOR_MOVING_AVERAGE_PERIOD: int = int(os.getenv("TRADING_SHADOWING_REGIME_CHRONICLE_PROFIT_FACTOR_MOVING_AVERAGE_PERIOD", "50"))
    TRADING_SHADOWING_REGIME_CHRONICLE_PROFIT_FACTOR_THRESHOLD: float = float(os.getenv("TRADING_SHADOWING_REGIME_CHRONICLE_PROFIT_FACTOR_THRESHOLD", "1.45"))
    ...
    TRADING_SHADOWING_REGIME_SPARSE_EXPECTED_VALUE_MOVING_AVERAGE_PERIOD: int = int(os.getenv("TRADING_SHADOWING_REGIME_SPARSE_EXPECTED_VALUE_MOVING_AVERAGE_PERIOD", "50"))
