...
class Settings:
    ...
    # --- Aave DCA ---
    AAVE_DCA_EMA50_OVERHEATING_DEFFER_TIME_HOURS: int = int(os.getenv("AAVE_DCA_EMA50_OVERHEATING_DEFFER_TIME_HOURS", "2"))
    AAVE_DCA_EMA50_WARMUP_KLINES: int = int(os.getenv("AAVE_DCA_EMA50_WARMUP_KLINES", "150"))
    AAVE_DCA_JITTER_MAX_PERCENT: float = float(os.getenv("AAVE_DCA_JITTER_MAX_PERCENT", "0.15"))
    AAVE_DCA_DELAY_MINUTES_MIN: int = int(os.getenv("AAVE_DCA_DELAY_MINUTES_MIN", "10"))
    AAVE_DCA_DELAY_MINUTES_MAX: int = int(os.getenv("AAVE_DCA_DELAY_MINUTES_MAX", "60"))
    AAVE_DCA_ASIAN_SESSION_START_HOUR: int = int(os.getenv("AAVE_DCA_ASIAN_SESSION_START_HOUR", "1"))
    AAVE_DCA_ASIAN_SESSION_END_HOUR: int = int(os.getenv("AAVE_DCA_ASIAN_SESSION_END_HOUR", "5"))
