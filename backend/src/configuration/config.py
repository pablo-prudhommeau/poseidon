...
class Settings:
    ...
    TRADING_MIN_VOLUME_5M_USD: float = float(os.getenv("TRADING_MIN_VOLUME_5M_USD", "10000"))
    ...
    TRADING_MIN_VOLUME_24H_USD: float = float(os.getenv("TRADING_MIN_VOLUME_24H_USD", "75000"))
    ...
    TRADING_MIN_AGE_HOURS: float = float(os.getenv("TRADING_MIN_AGE_HOURS", "0.5"))
    TRADING_MAX_AGE_HOURS: float = float(os.getenv("TRADING_MAX_AGE_HOURS", "168"))
    TRADING_MAX_ABSOLUTE_PERCENT_5M: float = float(os.getenv("TRADING_MAX_ABSOLUTE_PERCENT_5M", "25"))
    TRADING_MAX_ABSOLUTE_PERCENT_1H: float = float(os.getenv("TRADING_MAX_ABSOLUTE_PERCENT_1H", "60"))
    ...
    TRADING_RISK_WEAK_BUY_FLOW_RATIO: float = float(os.getenv("TRADING_RISK_WEAK_BUY_FLOW_RATIO", "0.48"))
    ...
    TRADING_SCORE_MIN_QUALITY: float = float(os.getenv("TRADING_SCORE_MIN_QUALITY", "60"))
