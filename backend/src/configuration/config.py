...
class Settings:
    ...
    TRADING_SHADOWING_REGIME_EMPIRICAL_PROFIT_FACTOR_WINDOW_VERDICT_COUNT: int = int(os.getenv("TRADING_SHADOWING_REGIME_EMPIRICAL_PROFIT_FACTOR_WINDOW_VERDICT_COUNT", "10000"))
    TRADING_SHADOWING_REGIME_EMPIRICAL_PROFIT_FACTOR_THRESHOLD: float = float(os.getenv("TRADING_SHADOWING_REGIME_EMPIRICAL_PROFIT_FACTOR_THRESHOLD", "1.00"))
