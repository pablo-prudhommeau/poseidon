...
class Settings:
    ...
    TRADING_SHADOWING_TOXIC_WIN_RATE_THRESHOLD: float = float(os.getenv("TRADING_SHADOWING_TOXIC_WIN_RATE_THRESHOLD", "0.35"))
    TRADING_SHADOWING_MAX_TOXIC_EXPOSURE: int = int(os.getenv("TRADING_SHADOWING_MAX_TOXIC_EXPOSURE", "0"))
    ...
    TRADING_SHADOWING_GOLDEN_WIN_RATE_THRESHOLD: float = float(os.getenv("TRADING_SHADOWING_GOLDEN_WIN_RATE_THRESHOLD", "0.55"))
