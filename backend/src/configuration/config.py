...
class Settings:
    ...
    TRADING_CORTEX_SUCCESS_PROBABILITY_THRESHOLD: float = float(os.getenv("TRADING_CORTEX_SUCCESS_PROBABILITY_THRESHOLD", "0.55"))
    TRADING_CORTEX_TOXICITY_PROBABILITY_THRESHOLD: float = float(os.getenv("TRADING_CORTEX_TOXICITY_PROBABILITY_THRESHOLD", "0.45"))
