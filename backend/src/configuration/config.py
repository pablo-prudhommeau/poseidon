...
class Settings:
    ...
    TRADING_SHADOWING_ENABLED: bool = _as_bool(os.getenv("TRADING_SHADOWING_ENABLED"), True)
    ...
    TRADING_SHADOWING_TP_MULTIPLIER_MIN: float = float(os.getenv("TRADING_SHADOWING_TP_MULTIPLIER_MIN", "0.5"))
    TRADING_SHADOWING_TP_MULTIPLIER_MAX: float = float(os.getenv("TRADING_SHADOWING_TP_MULTIPLIER_MAX", "2.5"))
    TRADING_SHADOWING_STALE_HOURS: float = float(os.getenv("TRADING_SHADOWING_STALE_HOURS", "12"))
    ...
    TRADING_SHADOWING_TOXIC_WIN_RATE_THRESHOLD: float = float(os.getenv("TRADING_SHADOWING_TOXIC_WIN_RATE_THRESHOLD", "0.40"))
    TRADING_SHADOWING_TOXIC_AVERAGE_PNL_THRESHOLD: float = float(os.getenv("TRADING_SHADOWING_TOXIC_AVERAGE_PNL_THRESHOLD", "-0.02"))
    TRADING_SHADOWING_TOXIC_HOLDING_TIME_THRESHOLD: float = float(os.getenv("TRADING_SHADOWING_TOXIC_HOLDING_TIME_THRESHOLD", "18.0"))
    TRADING_SHADOWING_TOXIC_CAPITAL_VELOCITY_THRESHOLD: float = float(os.getenv("TRADING_SHADOWING_TOXIC_CAPITAL_VELOCITY_THRESHOLD", "-0.50"))
    ...
    TRADING_SHADOWING_MIN_METRIC_INFLUENCE: float = float(os.getenv("TRADING_SHADOWING_MIN_METRIC_INFLUENCE", "40.0"))
