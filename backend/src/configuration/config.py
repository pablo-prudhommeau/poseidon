...
class Settings:
    ...
    TRADING_SHADOWING_MIN_OUTCOMES_FOR_ACTIVATION: int = int(os.getenv("TRADING_SHADOWING_MIN_OUTCOMES_FOR_ACTIVATION", "1000"))
    TRADING_SHADOWING_TOXIC_WIN_RATE_THRESHOLD: float = float(os.getenv("TRADING_SHADOWING_TOXIC_WIN_RATE_THRESHOLD", "0.40"))
    TRADING_SHADOWING_MAX_TOXIC_EXPOSURE: int = int(os.getenv("TRADING_SHADOWING_MAX_TOXIC_EXPOSURE", "2"))
    ...
    TRADING_SHADOWING_GOLDEN_WIN_RATE_THRESHOLD: float = float(os.getenv("TRADING_SHADOWING_GOLDEN_WIN_RATE_THRESHOLD", "0.60"))
    TRADING_SHADOWING_STALE_HOURS: int = int(os.getenv("TRADING_SHADOWING_STALE_HOURS", "12"))
    TRADING_SHADOWING_LETHARGIC_HOURS: int = int(os.getenv("TRADING_SHADOWING_LETHARGIC_HOURS", "24"))
