...
class Settings:
    ...
    TRADING_GATE_SHADOWING_PERFORMANCE_ENABLED: bool = _as_bool(os.getenv("TRADING_GATE_SHADOWING_PERFORMANCE_ENABLED"), True)
    ...
    TRADING_SHADOWING_PERFORMANCE_CHRONICLE_PROFIT_FACTOR_MOVING_AVERAGE_LOOKBACK_DAYS: float = float(os.getenv("TRADING_SHADOWING_PERFORMANCE_CHRONICLE_PROFIT_FACTOR_MOVING_AVERAGE_LOOKBACK_DAYS", "7.0"))
    TRADING_SHADOWING_PERFORMANCE_CHRONICLE_PROFIT_FACTOR_BUCKET_WIDTH_SECONDS: int = int(os.getenv("TRADING_SHADOWING_PERFORMANCE_CHRONICLE_PROFIT_FACTOR_BUCKET_WIDTH_SECONDS", "300"))
    TRADING_SHADOWING_PERFORMANCE_CHRONICLE_PROFIT_FACTOR_MOVING_AVERAGE_PERIOD: int = int(os.getenv("TRADING_SHADOWING_PERFORMANCE_CHRONICLE_PROFIT_FACTOR_MOVING_AVERAGE_PERIOD", "10"))
    TRADING_SHADOWING_PERFORMANCE_CHRONICLE_PROFIT_FACTOR_THRESHOLD: float = float(os.getenv("TRADING_SHADOWING_PERFORMANCE_CHRONICLE_PROFIT_FACTOR_THRESHOLD", "1.40"))
    TRADING_SHADOWING_PERFORMANCE_SPARSE_EXPECTED_VALUE_MOVING_AVERAGE_LOOKBACK_DAYS: float = float(os.getenv("TRADING_SHADOWING_PERFORMANCE_SPARSE_EXPECTED_VALUE_MOVING_AVERAGE_LOOKBACK_DAYS", "7.0"))
    TRADING_SHADOWING_PERFORMANCE_SPARSE_EXPECTED_VALUE_BUCKET_WIDTH_SECONDS: int = int(os.getenv("TRADING_SHADOWING_PERFORMANCE_SPARSE_EXPECTED_VALUE_BUCKET_WIDTH_SECONDS", "600"))
    TRADING_SHADOWING_PERFORMANCE_SPARSE_EXPECTED_VALUE_MOVING_AVERAGE_PERIOD: int = int(os.getenv("TRADING_SHADOWING_PERFORMANCE_SPARSE_EXPECTED_VALUE_MOVING_AVERAGE_PERIOD", "10"))
    TRADING_SHADOWING_PERFORMANCE_SPARSE_EXPECTED_VALUE_USD_THRESHOLD: float = float(os.getenv("TRADING_SHADOWING_PERFORMANCE_SPARSE_EXPECTED_VALUE_USD_THRESHOLD", "0.0"))
