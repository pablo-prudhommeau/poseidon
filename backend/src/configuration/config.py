...
class Settings:
    ...
    TRADING_SHADOWING_HISTORY_DELAY_MINUTES: int = int(os.getenv("TRADING_SHADOWING_HISTORY_DELAY_MINUTES", "10"))
    TRADING_SHADOWING_HISTORY_SERIES_END_LAG_SECONDS: int = int(os.getenv("TRADING_SHADOWING_HISTORY_SERIES_END_LAG_SECONDS", "120"))
