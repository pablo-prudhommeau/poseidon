...
class AaveSentinelSnapshotService:
    ...
    async def trigger_emergency_rescue(self) -> AaveSentinelRescueExecutionResult:
        ...
        try:
            ...
            required_rescue_collateral_base_units = (
                settings.AAVE_RESCUE_TARGET_HF_IMPROVEMENT * total_liabilities_base_units
            ) / settings.AAVE_RESCUE_USDC_LIQUIDATION_THRESHOLD
