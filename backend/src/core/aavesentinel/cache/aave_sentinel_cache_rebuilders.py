...
from src.core.aavesentinel.aave_sentinel_structures import AaveSentinelCapitalFlowSummary
from src.core.aavesentinel.aave_sentinel_structures import AaveSentinelPositionSnapshot
...
def register_aave_sentinel_rebuilders() -> None:
    ...
    logger.info("[AAVESENTINEL][CACHE][REBUILDERS] 2 sentinel rebuilders registered")
