...
def upgrade() -> None:
    ...
    operations.create_table(
        ...
        schema.Column("order_status", schema.String(length=24), nullable=False),
    ...
    operations.create_table(
        ...
        schema.Column("promotion_score", schema.Float(), nullable=True),
        ...
        schema.Column("shadowing_regime", schema.JSON(), nullable=True),
        schema.Column("shadowing_metrics", schema.JSON(), nullable=True),
        schema.Column("screener_envelope", schema.JSON(), nullable=False),
...
def downgrade() -> None:
    operations.drop_index("ix_trading_cortex_model_manifests_is_active", table_name="trading_cortex_model_manifests")
    operations.drop_index("ix_trading_cortex_model_manifests_model_version", table_name="trading_cortex_model_manifests")
