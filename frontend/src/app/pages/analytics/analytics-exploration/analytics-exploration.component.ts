                        ...
                        yaxis: [
                            ...
                            },
                            {
                                ...
                                labels: {
                                    ...
                                    formatter: (val: any) => `${Number(val).toFixed(0)}% WR`
                                },
                                title: { text: undefined },
                                min: 0,
                                max: 100
                            },
                            {
                                ...
                                labels: {
                                    ...
                                    formatter: (val: any) => (val ? `${Number(val).toFixed(1)} vel` : '0.0 vel')
                                },
                                title: { text: undefined }
                            },
                            {
                                ...
                                labels: {
                                    ...
                                    formatter: (val: any) => (val ? `${Number(val).toFixed(0)}% PnL` : '0% PnL')
                                },
                                title: { text: undefined }
                            }
                        ]
                        ...
                        yaxis: [
                            ...
                            },
                            {
                                ...
                                labels: {
                                    ...
                                    formatter: (val: any) => `${Number(val).toFixed(0)}% HR`
                                },
                                title: { text: undefined }
                            }
                        ]
