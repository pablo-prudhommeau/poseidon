import type {ChronicleChartModel, ChronicleLegendRenderableSeriesLike, ChronicleRenderableSeriesCollectionLike, ChronicleVisibilityToggleSeriesLike,} from '../data/shadow-verdict-chronicle.models';
...
export function setChronicleSeriesVisibility(
