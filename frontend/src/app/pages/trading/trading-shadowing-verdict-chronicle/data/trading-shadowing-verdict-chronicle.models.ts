...
export interface ChronicleArrays {
    ...
    cortexSkillScorePercentageSeries: number[];
    cortexCalibrationGapPercentagePointsSeries: number[];
    cortexHighConvictionAccuracyPercentageSeries: number[];
    cortexHighConvictionSharePercentageSeries: number[];
    cortexGatePrecisionPercentageSeries: number[];
    cortexGatePassRatePercentageSeries: number[];
    ...
    movingAverageCortexSkillScorePercentageSeries: number[];
    movingAverageCortexCalibrationGapPercentagePointsSeries: number[];
    movingAverageCortexHighConvictionAccuracyPercentageSeries: number[];
    movingAverageCortexHighConvictionSharePercentageSeries: number[];
    movingAverageCortexGatePrecisionPercentageSeries: number[];
    movingAverageCortexGatePassRatePercentageSeries: number[];
