...
export class TradingTradesTableComponent implements AfterViewInit {
    ...
    public ngAfterViewInit(): void {
        this.columnDefinitions = [
            ...
            },
            {
                ...
                valueGetter: (p: ValueGetterParams<TradingTradePayload>) => this.datetimeDisplayService.parseToDate((p.data as any)?.created_at),
                ...
                tooltipValueGetter: (p: ITooltipParams<TradingTradePayload>) => this.datetimeDisplayService.formatIsoForTooltip((p.data as any)?.created_at),
            ...
            },
            {
                ...
                valueFormatter: (p: ValueFormatterParams<TradingTradePayload>) => this.numberFormattingService.formatQuantityHumanReadable(p.value),
            ...
            },
            {
                ...
                sortable: true,
                filter: 'agNumberColumnFilter',
                valueFormatter: (p: ValueFormatterParams<TradingTradePayload>) => this.numberFormattingService.formatCurrency(p.value, 'USD', 2, 2),
            ...
            },
            {
                ...
                sortable: true,
                filter: 'agNumberColumnFilter',
                valueFormatter: (p: ValueFormatterParams<TradingTradePayload>) => this.numberFormattingService.formatUsdCompactForGrid(p.value),
                tooltipValueGetter: (p: ITooltipParams<TradingTradePayload>) =>
            ...
            },
            {
                ...
                cellRenderer: (p: ValueFormatterParams<TradingTradePayload>) => this.formatTransactionHashCellHtml(p.data ?? undefined),
    ...
    public buildSnapshotFromDiagnostics(
        ...
        return {
            summary: diagnostics.shadowing_summary,
